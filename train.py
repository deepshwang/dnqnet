        ...
        for e in range(args.epochs):
            ...
            for i, datum in enumerate(self.train_dataloader, 0):
                ...
                if (i + 1) % args.batch_iter == 0:
                    ...
                    # The loss calcluated here is sum of loss trPER mini-batch (128)
            ...
            if e == 0:
                ...
                if per_instance_loss_tracker < self.best_loss:
                    ...
                    elif args.save_mode == 'entire_models':
                        print("Val. loss improved: ", self.best_loss * args.train_batch, '-> ',
                              per_instance_loss_tracker * args.train_batch)
                        torch.save(self.model, args.save_bestmodel_name)
                        print("Model SAVED in ", args.save_bestmodel_name)
                    self.best_loss = per_instance_loss_tracker
                    self.stagger_count = 0
...
if __name__ == '__main__':
    ...
    if args.train_dataset == 'MNIST':
        ...
        train_dataloader = CIFAR100Dataloader(args, 'train', T_CIFAR100)
        val_dataloader = CIFAR100Dataloader(args, 'val', T_CIFAR100)
    ...
    if args.test_dataset == 'MNIST':
        ...
        test_dataloader = CIFAR100Dataloader(args, 'test', T_CIFAR100)

    elif args.test_dataset == 'RotCIFAR100':
        test_dataloader = CIFAR100Dataloader(args, 'test', T_CIFAR100_ROT)
